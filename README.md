...
The WFDownloader software is a type of downloader that allows you easily bulk download any kind of file such as images, videos, documents, attachments, etc., from a lot of supported sites but it can work on almost any website (not kidding) if you use its advanced features. It is free, simple, lightweight, extensible, and cross-platform so it works on Windows, Mac and Linux.
...
-   Can resume broken downloads and even refresh expired links on its own before resuming them.
...
-   Can [batch download images in their original quality directly from search engines](https://www.wfdownloader.xyz/blog/how-to-bulk-download-images-from-google-and-bing-search-engines) such as Google, Bing, or Yandex.
...
-   Allows queuing multiple jobs so that they can be executed one after the other ([batch link search](https://www.wfdownloader.xyz/blog/batch-link-search-how-to-queue-multiple-link-extractions-at-once)) without needing your supervision.
